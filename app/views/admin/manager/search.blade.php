	...
	{{ Form::open(array('action' => 'ManagerController@search', 'method' => 'GET')) }}
		...
		<!-- <div class="input-group" style="width: 150px; display:inline-block;">
			<label>Từ ngày đăng nhập</label>
		  	<input type="text" name="start_date" class="form-control dateformat" placeholder="Từ ngày" />
		</div>
		<div class="input-group" style="width: 150px; display:inline-block;">
			<label>Đến ngày đăng nhập</label>
		  	<input type="text" name="end_date" class="form-control dateformat" placeholder="Đến ngày" />
		</div> -->
